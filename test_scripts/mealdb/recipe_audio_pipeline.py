...
class RecipeAudioGenerator:
    def __init__(self):
        ...
        print("✅ AudioGenerator initialized with British English voice and Gemini client")
    ...
    def transform_with_gemini(self, instructions: str) -> str:
        """Transform recipe instructions using Gemini API"""
        print("\n✨ Transforming instructions with Gemini...")
        try:
            prompt = """
            ...
            print(f"Transformed instructions sample:\n{transformed[:200]}...")
            return transformed
        except Exception as e:
            print(f"❌ Gemini transformation failed: {str(e)}")
            return instructions  # Fall back to original if transformation fails
    ...
    def process_recipe(self, recipe: Dict) -> bool:
        ...
        try:
            ...
            # Transform instructions with Gemini first
            transformed = self.transform_with_gemini(instructions)
            normalized = self.normalize_instructions(transformed)
            ...
            if audio_steps:
                ...
                result = self.clients["mongo"].update_one(
                    ...
                    {"$set": {
                        ...
                        "transformed_instructions": transformed
                    }}
                )
...
def main():
    ...
    try:
        ...
        required_vars = ["MONGODB_URI", "GCP_PROJECT", "GEMINI_API_KEY"]
